...
colororder(cbcolor);
hold on; fill([1:600, flip(1:600)], [squeeze(rhoCI(:, 3, 1))', flip(squeeze(rhoCI(:, 3, 2)))'], 'r', 'FaceColor', cbcolor(3, :), ...
    'EdgeColor', 'none', 'FaceAlpha', 0.2);
hold on; fill([1:600, flip(1:600)], [squeeze(rhoCI(:, 2, 1))', flip(squeeze(rhoCI(:, 2, 2)))'], 'r', 'FaceColor', cbcolor(2, :), ...
    'EdgeColor', 'none', 'FaceAlpha', 0.2);
hold on; fill([1:600, flip(1:600)], [squeeze(rhoCI(:, 1, 1))', flip(squeeze(rhoCI(:, 1, 2)))'], 'r', 'FaceColor', cbcolor(1, :), ...
    'EdgeColor', 'none', 'FaceAlpha', 0.2);
